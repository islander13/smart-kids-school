        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {[
              ...
              { icon: '🗓️', title: currentLang === 'FR' ? 'Bilan de niveau offert' : currentLang === 'EN' ? 'Free level assessment' : 'Kostenlose Niveaubeurteilung',
                desc: currentLang === 'FR' ? "Un premier échange de 30 min avec un enseignant, sans engagement, pour évaluer le niveau de votre enfant." : currentLang === 'EN' ? "A first 30-minute chat with a teacher, no commitment, to assess your child's level." : 'Ein erstes 30-minütiges Gespräch mit einer Lehrperson, unverbindlich, zur Einschätzung des Niveaus Ihres Kindes.' },
            ].map((item, i) => (
