  ...
  return (
    <div className={`min-h-screen font-['Inter',sans-serif] transition-colors duration-300 ${darkMode ? 'bg-gray-950 text-white' : 'bg-white text-gray-900'}`}>
            ...
            <div className="relative">
              <div className={`relative rounded-3xl overflow-hidden shadow-2xl ${darkMode ? 'bg-gray-800' : 'bg-indigo-50'}`}>
                <picture>
                  ...
                  <img src="/home.jpg" alt="Enfants apprenant la programmation Scratch en ligne, Smart Kids School Suisse" fetchPriority="high" width="1200" height="762" className="w-full h-[480px] object-cover object-center" />
                </picture>
        ...
        <div className="max-w-5xl mx-auto">
          <div className="flex flex-col items-center gap-4">
            ...
            <div className="flex flex-wrap items-center justify-center gap-x-16 gap-y-4">
              <img src="/epfl.png" alt="EPFL, École Polytechnique Fédérale de Lausanne" loading="lazy" width="1536" height="864" className={`h-16 md:h-20 w-auto transition-all ${darkMode ? 'invert' : ''}`} />
              <img src="/ethz.png" alt="ETH Zürich, Eidgenössische Technische Hochschule Zürich" loading="lazy" width="600" height="220" className={`h-16 md:h-20 w-auto transition-all ${darkMode ? 'invert' : ''}`} />
            </div>
      ...
      <ProjectGallery
        ...
        bgClass={darkMode ? 'bg-gray-900' : 'bg-white'}
        eyebrow={currentLang === 'FR' ? 'Réalisé par nos élèves' : currentLang === 'EN' ? 'Made by our students' : 'Von unseren Schülern erstellt'}
        title={currentLang === 'FR' ? 'Leurs premiers jeux vidéo' : currentLang === 'EN' ? 'Their first video games' : 'Ihre ersten Videospiele'}
        description={
          currentLang === 'FR'
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {[
              ...
              { icon: '🗓️', title: currentLang === 'FR' ? "Cours d'essai gratuit" : currentLang === 'EN' ? 'Free trial lesson' : 'Kostenlose Probestunde',
                desc: currentLang === 'FR' ? "Votre enfant rencontre le professeur, on évalue son niveau, et on répond à toutes vos questions. Sans engagement." : currentLang === 'EN' ? 'Your child meets the teacher, we assess their level, and answer all your questions. No commitment.' : 'Ihr Kind lernt die Lehrperson kennen, wir beurteilen sein Niveau und beantworten alle Ihre Fragen. Unverbindlich.' },
            ].map((item, i) => (
