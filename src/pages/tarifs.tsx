        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-20">
            ...
            <div className="hidden md:flex items-center gap-8 ml-8">
              ...
              <a href={lp('/tarifs')} className={darkMode ? 'text-sm font-semibold text-indigo-400 whitespace-nowrap' : 'text-sm font-semibold text-[#232999] whitespace-nowrap'}>{t.nav.tarifs}</a>
            ...
            <div className="hidden md:flex items-center gap-3 ml-6">
              ...
              <button onClick={() => document.getElementById('tarifs-detailles')?.scrollIntoView({ behavior: 'smooth', block: 'start' })} className="bg-[#232999] hover:bg-[#1a1f7a] text-white px-6 py-3 rounded-full text-sm font-semibold hover:shadow-lg transform hover:scale-105 transition-all duration-300 whitespace-nowrap cursor-pointer">{t.nav.enroll}</button>
            </div>
                ...
                {checkout.error ? (
                  <div className="flex flex-col items-center justify-center py-16 gap-4 text-center">
                    ...
                    <div className="flex flex-col sm:flex-row gap-2 w-full max-w-sm">
                      <button onClick={() => { checkout.reset(); setPlanSubmitMessage(''); }} className="flex-1 bg-[#232999] hover:bg-[#1a1f7a] text-white px-5 py-2.5 rounded-full text-sm font-semibold transition-all cursor-pointer">
