              ...
              <div className="lg:pt-4">
                ...
                <div className="space-y-5">
                  {[
                    ...
                    { icon: 'ri-download-2-line', t: { FR: 'Ressources à télécharger', EN: 'Downloadable resources', DE: 'Herunterladbare Ressourcen' }, d: { FR: 'Fiches, exercices et projets pratiques, selon le langage suivi (Scratch, Python…), pour pratiquer hors ligne', EN: 'Worksheets, exercises and hands-on projects, matching the language being learned (Scratch, Python…), to practise offline', DE: 'Arbeitsblätter, Übungen und praktische Projekte je nach gelernter Sprache (Scratch, Python…), zum Offline-Üben' } },
                  ].map((item, i) => (
