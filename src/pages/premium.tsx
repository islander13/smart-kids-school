...
export default function Premium() {
  ...
  const T = {
    FR: {
      ...
      submitSuccess: 'Demande enregistrée, Redirection vers Stripe...',
    ...
    EN: {
      ...
      submitSuccess: 'Request recorded, Redirecting to Stripe...',
    ...
    DE: {
      ...
      submitSuccess: 'Anfrage erfasst, Weiterleitung zu Stripe...',
