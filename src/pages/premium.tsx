...
export default function Premium() {
  ...
  const T = {
    FR: {
      ...
      submitError: 'Une erreur est survenue. Merci de nous écrire à contact@smartkids-school.ch ou via WhatsApp.',
    ...
    EN: {
      ...
      submitError: 'An error occurred. Please email contact@smartkids-school.ch or use WhatsApp.',
    ...
    DE: {
      ...
      submitError: 'Ein Fehler ist aufgetreten. Bitte schreiben Sie an contact@smartkids-school.ch oder via WhatsApp.',
                ...
                {checkout.error ? (
                  <div className="flex flex-col items-center justify-center py-16 gap-4 text-center">
                    ...
                    <div className="flex flex-col sm:flex-row gap-2 w-full max-w-sm">
                      <button onClick={() => { checkout.reset(); setSubmitMessage(''); }} className="flex-1 bg-gradient-to-r from-amber-500 to-amber-600 hover:from-amber-600 hover:to-amber-700 text-white px-5 py-2.5 rounded-full text-sm font-semibold transition-all cursor-pointer">
